...
def candidator(main_list, rowlist_oblist, x):
    ...
    for number in main_list:
        digit = str(number)
        if int(digit[4]) == int(rowlist_oblist[int(x)]):
...
def exhausterL4():
    for sublist in len_order:
        ...
        if sublist[len(sublist) - 1] == 0 and sublist == len_order[4]:
            ...
            while index < len(sublist):
                ...
                row_3 = matrix[3, :]
                row_4 = matrix[4, :]
                nested_list_of_rows.extend((row_0, row_1, row_2, row_3, row_4))
                if solution_check(nested_list_of_rows) is True:
                    print(matrix)
                if list(matrix[:, 0]) == list(matrix[0, :]) and list(matrix[:, 1]) == list(matrix[1, :]) and list(
                        matrix[:, 2]) == list(matrix[2, :]) and list(matrix[:, 3]) == list(matrix[3, :]) and list(
                    matrix[:, 4]) == list(matrix[4, :]):
                    symmetric_matrices += 1
                index += 1
            sublist.append(0)
        elif sublist[len(sublist) - 1] == 1 and sublist == len_order[4]:
            sublist.remove(sublist[len(sublist) - 1])
            index = 0
            while index < len(sublist):
                ...
                index += 1
            sublist.append(1)
        elif sublist[len(sublist) - 1] == 2 and sublist == len_order[4]:
            sublist.remove(sublist[len(sublist) - 1])
            index = 0
            while index < len(sublist):
                ...
                index += 1
            sublist.append(2)
        elif sublist[len(sublist) - 1] == 3 and sublist == len_order[4]:
            sublist.remove(sublist[len(sublist) - 1])
            index = 0
            while index < len(sublist):
                ...
                index += 1
            sublist.append(3)
        elif sublist[len(sublist) - 1] == 4 and sublist == len_order[4]:
            sublist.remove(sublist[len(sublist) - 1])
            index = 0
            while index < len(sublist):
                matrix[:, 4] = sublist[index]
                nested_list_of_rows = []
                row_0 = matrix[0, :]
                row_1 = matrix[1, :]
                row_2 = matrix[2, :]
...
def exhausterL3():
    for sublist in len_order:
        if sublist[len(sublist) - 1] == 0 and sublist == len_order[3]:
            ...
            while index < len(sublist):
                matrix[:, 0] = sublist[index]
                exhausterL4()  # EXHAUSTER 4 LEVEL 1
                index += 1
            sublist.append(0)
            ...
            while index < len(sublist):
                matrix[:, 1] = sublist[index]
                exhausterL4()  # EXHAUSTER 4 LEVEL 2
                index += 1
            sublist.append(1)
            ...
            while index < len(sublist):
                matrix[:, 2] = sublist[index]
                exhausterL4()  # EXHAUSTER 4 LEVEL 3
                index += 1
            sublist.append(2)
            ...
            while index < len(sublist):
                matrix[:, 3] = sublist[index]
                exhausterL4()  # EXHAUSTER 4 LEVEL 4
                index += 1
            sublist.append(3)
        elif sublist[len(sublist) - 1] == 4 and sublist == len_order[3]:
            sublist.remove(sublist[len(sublist) - 1])
            index = 0
            while index < len(sublist):
                matrix[:, 4] = sublist[index]
                exhausterL4()  # EXHAUSTER 4 LEVEL 5
                index += 1
            sublist.append(4)
    ...
    for sublist in len_order:
        if sublist[len(sublist) - 1] == 0 and sublist == len_order[2]:
            ...
            while index < len(sublist):
                ...
                index += 1
            sublist.append(3)
        elif sublist[len(sublist) - 1] == 4 and sublist == len_order[2]:
            sublist.remove(sublist[len(sublist) - 1])
            index = 0
            while index < len(sublist):
                matrix[:, 4] = sublist[index]
                exhausterL3()  # EXHAUSTER 3 LEVEL 5
                index += 1
            sublist.append(4)
    ...
    for sublist in len_order:
        if sublist[len(sublist) - 1] == 0 and sublist == len_order[1]:
            ...
            while index < len(sublist):
                ...
                index += 1
            sublist.append(3)
        elif sublist[len(sublist) - 1] == 4 and sublist == len_order[1]:
            sublist.remove(sublist[len(sublist) - 1])
            index = 0
            while index < len(sublist):
                matrix[:, 4] = sublist[index]
                exhausterL2()  # EXHAUSTER 2 LEVEL 5
                index += 1
            sublist.append(4)
    ...
    for sublist in len_order:
        if sublist[len(sublist) - 1] == 0 and sublist == len_order[0]:
            ...
            while index < len(sublist):
                ...
                index += 1
            sublist.append(3)
        elif sublist[len(sublist) - 1] == 4 and sublist == len_order[0]:
            sublist.remove(sublist[len(sublist) - 1])
            index = 0
            while index < len(sublist):
                matrix[:, 4] = sublist[index]
                exhausterL1()  # EXHAUSTER 1 LEVEL 5
                index += 1
            sublist.append(4)
...
while index < len(list_b):
    ...
    bottom_row = oblist(list_b, index)

    matrix[4, :] = bottom_row

    candidates_0 = candidator(list_a, bottom_row, 0)
    candidates_1 = candidator(list_a, bottom_row, 1)
    candidates_2 = candidator(list_a, bottom_row, 2)
    candidates_3 = candidator(list_a, bottom_row, 3)
    candidates_4 = candidator(list_b, bottom_row, 4)
